...
exports.getSellerDashboard = exports.getMe = void 0;
...
exports.getMe = (0, async_handler_1.asyncHandler)(async (req, res) => {
    ...
    res.status(200).json((0, api_response_1.successResponse)("User profile fetched", user));
});
exports.getSellerDashboard = (0, async_handler_1.asyncHandler)(async (req, res) => {
    if (!req.user)
        throw new error_handler_1.AppError("Unauthorized", 401);
    const data = await service.getSellerDashboard(req.user.id);
    res.status(200).json((0, api_response_1.successResponse)("Seller dashboard data fetched", data));
});
